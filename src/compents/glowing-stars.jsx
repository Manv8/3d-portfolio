...
export const GlowingStarsDescription = ({
  ...
  return (
    <p className={twMerge("text-base text-white max-w-[16rem]", className)}>
      {children}
    </p>
  );
};
...
export const GlowingStarsTitle = ({
  ...
  return (
    <h2 className={twMerge("font-bold text-2xl text-[#eaeaea]", className)}>
      {children}
    </h2>
  );
};
...
const Star = ({
  ...
  return (
    <motion.div
      ...
      className={twMerge("bg-[#666] h-[1px] w-[1px] rounded-full relative z-20")}></motion.div>
  );
};
